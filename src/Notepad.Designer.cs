namespace NewAshAIO
{
    partial class NoteSheets
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.Whatsthis.Click += new System.EventHandler(this.WhatsthisClick);
        	// 
        	// AddSheet
        	// 
        	...
        	this.AddSheet.Click += new System.EventHandler(this.AddSheetClick);
        	// 
        	// SheetSelection
        	// 
        	...
        	this.Load += new System.EventHandler(this.NoteSheetsLoad);
