...
namespace NewAshAIO
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (NewAshAIO.ValidMemory.rangeCheckId(startdump) != NewAshAIO.ValidMemory.rangeCheckId(enddump))
            {
                enddump = NewAshAIO.ValidMemory.ValidAreas[NewAshAIO.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!NewAshAIO.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!NewAshAIO.ValidMemory.validAddress(address))
            {
                return 0;
            }
